...
DOMAIN = "ha_container_updater"
INTEGRATION_NAME = "HA Container Updater"
...
CONF_LOCK_FILE = "lock_file"

# ── Defaults ──────────────────────────────────────────────────────────────────
DEFAULT_COMPOSE_DIR = "/home/pi/homeassistant"
DEFAULT_LOCK_FILE = "/tmp/ha-container-updater.lock"  # noqa: S108 (intentional /tmp use)
DEFAULT_COMPOSE_FILE = "docker-compose.yml"
DEFAULT_HA_SERVICE_NAME = "homeassistant"
DEFAULT_TRIGGER_FILE = "/tmp/ha-container-updater-trigger"   # noqa: S108  (intentional /tmp use)
...
TRIGGER_FILE_MAGIC = "ha_container_updater_REQUESTED"
...
# ── Logging prefix ────────────────────────────────────────────────────────────
LOG_PREFIX = "[ha-container-updater]"